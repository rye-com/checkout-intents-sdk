import fs from 'fs';
import type { ResponseLike } from 'checkout-intents/internal/to-file';
import { toFile } from 'checkout-intents/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('checkout-intents/core/uploads');
    await expect(
