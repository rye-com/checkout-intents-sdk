...
describe('resource checkoutIntents', () => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.checkoutIntents.list({
    id: ['string'],
    after: 'after',
    before: 'before',
    limit: 1,
  ...
  test.skip('addPayment: only required params', async () => {
    const responsePromise = client.checkoutIntents.addPayment('id', { paymentMethod: { stripeToken: 'tok_1RkrWWHGDlstla3f1Fc7ZrhH', type: 'stripe_token' } });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('addPayment: required and optional params', async () => {
    const response = await client.checkoutIntents.addPayment('id', { paymentMethod: { stripeToken: 'tok_1RkrWWHGDlstla3f1Fc7ZrhH', type: 'stripe_token' } });
  });

  // Mock server tests are disabled
  test.skip('confirm: only required params', async () => {
    const responsePromise = client.checkoutIntents.confirm('id', { paymentMethod: { stripeToken: 'tok_1RkrWWHGDlstla3f1Fc7ZrhH', type: 'stripe_token' } });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('confirm: required and optional params', async () => {
    const response = await client.checkoutIntents.confirm('id', { paymentMethod: { stripeToken: 'tok_1RkrWWHGDlstla3f1Fc7ZrhH', type: 'stripe_token' } });
  });
