...
- <code>client.checkoutIntents.<a href="./src/resources/checkout-intents/checkout-intents.ts">pollUntilCompleted</a>(id, options?) -> Promise&lt;CheckoutIntent&gt;</code>
- <code>client.checkoutIntents.<a href="./src/resources/checkout-intents/checkout-intents.ts">pollUntilAwaitingConfirmation</a>(id, options?) -> Promise&lt;CheckoutIntent&gt;</code>
- <code>client.checkoutIntents.<a href="./src/resources/checkout-intents/checkout-intents.ts">createAndPoll</a>({ ...params }, options?) -> Promise&lt;CheckoutIntent&gt;</code>
- <code>client.checkoutIntents.<a href="./src/resources/checkout-intents/checkout-intents.ts">confirmAndPoll</a>(id, { ...params }, options?) -> Promise&lt;CheckoutIntent&gt;</code>
