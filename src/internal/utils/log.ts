...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: CheckoutIntents): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: CheckoutIntents): Logger {
